...
INSERT INTO moments (author, emotion, body, lat, lng, created_at) VALUES
  ...
  ('Sam', 'Afraid', 'This might not be for me - I don\'t do great with heights.', 37.80184969073113, -122.40576267242432, '2015-11-11'),
  ('Alyssa', 'Angry', 'So much traffic!', 37.78299392223508, -122.39529132843018, '2015-11-11'),
  ('Charles', 'Happy', 'Can\'t beat an Anchor Steam', 37.76284413400416, -122.39992618560791, '2015-11-11'),
  ...
  ('Charles', 'Content', 'Happy it\'s Friday! Ready to go relax', 37.397096202696275, -122.08140850067139, '2015-11-20'),
